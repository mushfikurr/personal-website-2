...
export default function Navbar(props) {
  return (
    <div className="font-iAMono bg-darker-gray fixed z-50 mx-4 my-2 h-20 w-[calc(100vw-(theme(spacing.4)*2))] bg-opacity-90 backdrop-blur-sm sm:mx-24 sm:my-12 sm:w-[calc(100vw-(theme(spacing.24)*2))]">
